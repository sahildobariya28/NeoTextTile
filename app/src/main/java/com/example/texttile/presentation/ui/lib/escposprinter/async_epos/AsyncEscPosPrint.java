package com.example.texttile.presentation.ui.lib.escposprinter.async_epos;
...
import com.example.texttile.presentation.ui.lib.escposprinter.EscPosCharsetEncoding;
import com.example.texttile.presentation.ui.lib.escposprinter.EscPosPrinter;
...
import com.example.texttile.presentation.ui.lib.escposprinter.exceptions.EscPosParserException;
    ...
    protected PrinterStatus doInBackground(AsyncEscPosPrinter... printersData) {
        ...
        try {
            ...
            for(String textToPrint : textsToPrint) {
                printer.printFormattedTextAndCut(textToPrint, 0);
                Thread.sleep(500);
            }
    ...
    protected void onPostExecute(PrinterStatus result) {
        ...
        switch (result.getPrinterStatus()) {
            case AsyncEscPosPrint.FINISH_SUCCESS:
                DialogUtil.show_printer_dialog(context, "Success", "Congratulation ! The texts are printed !", R.drawable.printer_success );
...
//                        .show();
            ...
            case AsyncEscPosPrint.FINISH_NO_PRINTER:
                DialogUtil.show_printer_dialog(context, "No printer", "The application can't find any printer connected.", R.drawable.printer_brocken_connection);
...
//                        .show();
            ...
            case AsyncEscPosPrint.FINISH_PRINTER_DISCONNECTED:
                DialogUtil.show_printer_dialog(context, "Broken connection", "Unable to connect the printer.", R.drawable.printer_brocken_connection);
...
//                    .show();
            ...
            case AsyncEscPosPrint.FINISH_PARSER_ERROR:
                DialogUtil.show_printer_dialog(context, "Invalid formatted text", "It seems to be an invalid syntax problem.", R.drawable.invalid_formate);
...
//                    .show();
            ...
            case AsyncEscPosPrint.FINISH_ENCODING_ERROR:
                DialogUtil.show_printer_dialog(context, "Bad selected encoding", "The selected encoding character returning an error.", R.drawable.encoding_error);
...
//                    .show();
            ...
            case AsyncEscPosPrint.FINISH_BARCODE_ERROR:
                DialogUtil.show_printer_dialog(context, "Invalid barcode", "Data send to be converted to barcode or QR code seems to be invalid.", R.drawable.invalid_qr_code);
